...
using SkillResultsAPI.Providers;
using SkillResultsAPI.Results;
using System.Linq;
...
namespace SkillResultsAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        /// <summary>
        /// Get Current User from Claim of Auth Token
        /// </summary>
        /// <returns></returns>
        public User getUser()
        {
            ...
            if (userId != null)
            {
                ...
                sqlCmd.CommandText = "SELECT o.OrgId, o.UserId, o.Admin, a.UserName FROM OrganizationUsers as o, AspNetUsers as a WHERE o.UserId = a.Id AND o.UserId = @userId";
                ...
                while (reader.Read())
                {
                    ...
                    user.OrgId = (int)reader["OrgId"];
                    user.UserId = (string)reader["UserId"];
                    user.Admin = (int)reader["Admin"];
        ...
        // GET api/Account/UserObject
        //Custom API Endpoint to Return Everything about the current user - JDN
        [HostAuthentication(DefaultAuthenticationTypes.ExternalBearer)]
        [Route("UserObject")]
        public IEnumerable<UserObjectViewModel> GetUserObject()
        {
            string sqlstring = "EXEC dbo.user_object @userId = '" + getUserId() + "'";
        ...
        public async Task<IHttpActionResult> Registeradmin(RegisterAdminBindingModel model)
        {
            ...
            string sqlinsertorg = "INSERT INTO Organizations (Name, MaxUsers) values (@Name, @MaxUsers);SELECT SCOPE_IDENTITY()";
            ...
            cmd.Parameters.Add("@MaxUsers", SqlDbType.Int);
            cmd.Parameters["@MaxUsers"].Value = model.MaxUsers;
